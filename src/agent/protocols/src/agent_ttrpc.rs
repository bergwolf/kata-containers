...
impl AgentServiceClient {
    ...
    pub fn pull_image(&self, req: &super::agent::PullImageRequest, timeout_nano: i64) -> ::ttrpc::Result<super::agent::PullImageResponse> {
        let mut cres = super::agent::PullImageResponse::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "grpc.AgentService", "PullImage", cres);
        Ok(cres)
    }
}
...
impl ::ttrpc::MethodHandler for PullImageMethod {
    fn handler(&self, ctx: ::ttrpc::TtrpcContext, req: ::ttrpc::Request) -> ::ttrpc::Result<()> {
        ::ttrpc::request_handler!(self, ctx, req, agent, PullImageRequest, pull_image);
        Ok(())
    }
}
...
pub trait AgentService {
    ...
    fn pull_image(&self, _ctx: &::ttrpc::TtrpcContext, _req: super::agent::PullImageRequest) -> ::ttrpc::Result<super::agent::PullImageResponse> {
        Err(::ttrpc::Error::RpcStatus(::ttrpc::get_status(::ttrpc::Code::NOT_FOUND, "/grpc.AgentService/PullImage is not supported".to_string())))
    }
}
...
pub fn create_agent_service(service: Arc<std::boxed::Box<dyn AgentService + Send + Sync>>) -> HashMap <String, Box<dyn ::ttrpc::MethodHandler + Send + Sync>> {
    ...
    methods.insert("/grpc.AgentService/PullImage".to_string(),
